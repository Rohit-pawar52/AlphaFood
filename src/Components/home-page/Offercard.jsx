...
function Offercard() {
  return (
    <div className="grid gap-5 sm:grid-cols-2 sm:place-items-center lg:flex justify-evenly md:px-10 lg:px-20 py-5 md:py-14 bg-pink-100">
        ...
        <div className="rounded-md border w-80 h-64 bg-red-500 p-5 bg-[url('/offer/pizza.png')] bg-right-bottom bg-[length:150px_150px] bg-no-repeat">
